...
INTEGER(SP) :: NUMBER_OF_LINES,NUMBER_OF_NODES
INTEGER(SP) :: STATUS_READ,IERR
INTEGER(SP) :: NX,NY,NZ
INTEGER(SP),dimension(:,:),allocatable :: sendbuf
INTEGER(SP),dimension(:),allocatable :: recvbuf
INTEGER(SP) :: NXM,NYM
INTEGER(SP) :: NPROC
INTEGER(SP) :: PROCNUM
INTEGER(SP),PARAMETER :: ROOT = 0
!INTEGER(SP) :: status(MPI_STATUS_SIZE)
REAL(DP) :: MEANVAL
REAL(DP) :: SIGMA
INTEGER :: N,K,I,J,M
!INTEGER(SP) :: DIMENS
REAL :: XMIN,XMAX,YMIN,YMAX,LX,LY
DOUBLE PRECISION :: X,Y
REAL(DP) :: UX,UY,UZ
INTEGER(DP) :: PLAN


DOUBLE PRECISION,DIMENSION(2) :: UM
INTEGER(SP),DIMENSION(:),ALLOCATABLE :: INDX,INDY,INDZ
!####################TEST########
INTEGER(SP) :: LENSAVE
INTEGER(SP) :: INC
INTEGER(SP) :: LENR
...
REAL(DP),DIMENSION(:),ALLOCATABLE :: TESTVECTOR
!REAL(SP),POINTER :: VELO(:)
DOUBLE PRECISION,DIMENSION(:),ALLOCATABLE :: R11
REAL(DP),DIMENSION(:,:,:),ALLOCATABLE :: UUX,UUY,UUZ
REAL(DP),DIMENSION(:,:,:),ALLOCATABLE :: UUX_loc,UUY_loc,UUZ_loc
...
COMPLEX(DPC),DIMENSION(:,:,:),ALLOCATABLE :: DUMMY1
COMPLEX(DPC),DIMENSION(:,:,:),ALLOCATABLE :: DUMMY2

COMPLEX(DPC),DIMENSION(:,:),ALLOCATABLE :: TEST_IN
COMPLEX(DPC),DIMENSION(:,:,:),ALLOCATABLE :: TEST_OUT
